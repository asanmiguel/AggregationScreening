function [trld rgiZStackImage time_elapsed] = GetZStackStepperG(CDevices,CCam,CStageSettings)
...
iWidth = 1280;
iHeight = 960;
rgiZStackImage=uint16(zeros(iHeight,iWidth,uiFocalPlanesNumber));
...
for i=1:uiFocalPlanesNumber
    fprintf(CDevices.pSerial,strZTravelDistance);
    fscanf(CDevices.pSerial);
    rgiZStackImage(1:960,1:1280,i)= getsnapshot(CCam.pCam1);
