function status=st_mutant_flushing(Valve)
...
calllib('PacDrive','PacSetLEDState',Valve.DevId,Valve.WildType,Valve.Open);
calllib('PacDrive','PacSetLEDState',Valve.DevId,Valve.Mutant,Valve.Closed);
